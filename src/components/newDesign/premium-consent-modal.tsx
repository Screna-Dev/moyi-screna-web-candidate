...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    body: (
      <>
        <p className="mb-2"><strong>4.1 Automatic Renewal.</strong> Your Premium Membership is a <strong>recurring subscription</strong> that renews automatically at the conclusion of each billing period (monthly or quarterly). By subscribing, you authorize Screna to charge the payment method on file at the then-applicable renewal rate, unless you cancel prior to the renewal date.</p>
