  ...
  useEffect(() => {
    ...
    getProfile()
      .then((res: { data: { data?: { structured_resume?: ProfileData }; structured_resume?: ProfileData } }) => {
        ...
        // Flatten skills: each Skill has { category, items: SkillItem[] }
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 pt-6 pb-4 border-b border-border shrink-0">
                <div>
                  ...
                  {!mentorSubmitted && (
                    <p className="text-muted-foreground text-[12px] mt-0.5">Step {mentorStep} of 4</p>
                  )}
                </div>
                <button
                  onClick={() => { setIsBecomeMentorOpen(false); resetMentorModal(); }}
              ...
              <div className="flex-1 overflow-y-auto px-6 py-5">
                ...
                {mentorSubmitted && (
                  <div className="flex flex-col items-center text-center py-6 gap-4">
                    ...
                    <div>
                      <h3 className="text-foreground text-[16px] mb-2" style={{ fontWeight: 600 }}>You're on the list!</h3>
                  ...
                  <div className="flex flex-col gap-5">
                    ...
                    <div className="rounded-xl border border-border bg-card p-4">
                      ...
                      <ul className="flex flex-col gap-2">
                        {[
                          'Your application is reviewed by our team (1–3 business days)',
                          'Once approved, your profile goes live on the marketplace',
                          'Candidates can book sessions directly on your calendar',
                        ].map((item, i) => (
              ...
              {!mentorSubmitted && (
                <div className="px-6 py-4 border-t border-border flex items-center justify-between shrink-0">
                  <button
                    onClick={() => mentorStep > 1 ? setMentorStep(s => s - 1) : (setIsBecomeMentorOpen(false), resetMentorModal())}
                  ...
                  {mentorStep < 4 ? (
                    ...
                    <button
                      ...
                      disabled={mentorSubmitting || !calendarConnected}
                      className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-primary text-primary-foreground text-[13px] hover:bg-primary/90 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                      style={{ fontWeight: 500 }}
                    >
